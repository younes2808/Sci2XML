...
def main():
    ...
    # 3. Interactive loop for processing new files or folders
    while True:
        print("\nEnter a command to process a new PDF or folder, or type 'exit' to quit.")
        user_input = input("Command (folder/pdf/output): ").strip().lower()
        ...
        if user_input == "exit":
            ...
            if os.path.isfile(pdf_file):
                ...
                print("Invalid PDF file path. Please try again.")

        else:
            print("Invalid command. Please enter 'folder' or 'pdf'.")
